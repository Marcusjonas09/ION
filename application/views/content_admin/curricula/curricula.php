              ...
              <div class="box box-success">
                  ...
                  <div class="box-body">
                      <table class="table table-bordered table-responsive">
                          ...
                          <?php for ($y = 1; $y < 5; $y++) : ?>
                              <tr>
                                  <th class="text-center" style="background-color:#00a65a; color:white;" colspan="6"><?= 'YEAR: ' . $y ?></th>
                              </tr>
                              <?php for ($t = 1; $t < 4; $t++) : ?>
                                  <tr>
                                      <th style="background-color:#ccc;" colspan="6"><?= 'Term: ' . $t ?></th>
                                  </tr>
                                      ...
                                      <?php if ($cur->Year == $y && $cur->Term == $t) : ?>
                                          <?php if (!empty($grades)) : ?>
                                              <?php foreach ($grades as $grade) : ?>
                                                  ...
                                                  <tr class="<?php if ($cur->course_code == $grade->course_taken && $grade->status) {
                                                                                                echo "bg-success";
                                                                                            } else {
                                                                                                echo "bg-default";
                                                                                            } ?>">
